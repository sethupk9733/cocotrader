...
const defaultSeedData = {
  ...
  clients: [
    {
      ...
      quickCashBalance: 2000,
      quickCashHistory: [
        { id: "qcash_c1", date: "2026-08-15", amount: 2000, notes: "Mid-cycle quick cash for farm fertilizer", status: "unpaid" }
      ],
      advanceHistory: [
  ...
  workers: [
    {
      ...
      advanceBalance: 5000,
      quickCashBalance: 1000,
      quickCashHistory: [
        { id: "qcash_w1", date: "2026-08-16", amount: 1000, notes: "Pre-payday quick cash advance", status: "unpaid" }
      ],
      payrollHistory: [],
      advanceHistory: [
  ...
  attendanceLogs: [
    { id: "att_1", lotId: "lot_102", date: "2026-08-19", workerId: "wrk_1", role: "cutter", status: "present", allocatedNutCount: 4250 },
    { id: "att_2", lotId: "lot_102", date: "2026-08-19", workerId: "wrk_2", role: "cutter", status: "present", allocatedNutCount: 4250 },
    { id: "att_3", lotId: "lot_102", date: "2026-08-19", workerId: "wrk_3", role: "picker", status: "present", allocatedNutCount: 8500 },
    { id: "att_5", lotId: "lot_102", date: "2026-08-19", workerId: "wrk_5", role: "driver", status: "present", allocatedNutCount: 8500 },
    { id: "att_6", lotId: "lot_102", date: "2026-08-19", workerId: "wrk_6", role: "dehusker", status: "present", allocatedNutCount: 8500 }
  ],
  clientBills: [
    {
      id: "bill_101",
      ...
      quickCashDeduction: 0,
      transportDeduction: 1200,
      bonusAmount: 0,
      netPayable: 64050,
      paymentMethod: "UPI",
